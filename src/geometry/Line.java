...
/**
 * A class that configures the object geometry.Line.
 */
public class Line implements DrawableShape {
     ...
     *
     * @return new geometry.Point that is the middle point
     */
    public Point middle() {
        //middle x coordinate
     ...
     *
     * @return new geometry.Point that is the starting point
     */
    public Point start() {
     ...
     *
     * @return new geometry.Point that is the end point
     */
    public Point end() {
        //get starting coordinates of this line
        double x = this.x2;
     ...
     * @return new geometry.Point if lines intersect, null otherwise
     */
     ...
     * @return geometry.Point the closest point out of the array of points intersected
     * with rectangle
     */
     ...
     * set line's color.
     *
     * @param lColor the color of line
     */
    ...
    public void draw(DrawSurface d) {
        d.setColor(color);
        d.drawLine((int) this.x1, (int) this.y1,
                (int) this.x2, (int) this.y2);
    }
}
