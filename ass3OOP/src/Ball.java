...
public class Ball implements Sprite {
     ...
     *
     * @param uGame the GameEnvironment to set
     */
    ...
    public void moveOneStep() {
        ...
        if (collision == null) {
            ...
            this.setVelocity(collision.collisionObject().hit(
     ...
     * @return Point the center of the ball right before the collision
     */
    ...
    /**
     * add this ball to the game given.
     *
