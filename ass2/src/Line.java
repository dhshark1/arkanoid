...
public class Line {
    ...
    public boolean isIntersecting(Line other) {
        ...
        //find potential intersecting point
        double x = this.findXCoordinate(b1, b2, m1, m2);
        double y = this.findYCoordinate(m1, x, b1);
        Point p = new Point(x, y);
        //check if point is on segment
        return (this.pointInSegment(p) && other.pointInSegment(p));
    }
    ...
    public Point intersectionWith(Line other) {
        ...
        //if lines don't intersect return null
        return null;
    }
